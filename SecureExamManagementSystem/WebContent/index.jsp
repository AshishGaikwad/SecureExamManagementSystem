						...
						<!-- <form action="#" method="post"> -->
							...
							<div class="row">
								...
								<div class=" text-right">
									<button type="button" id="SubmitUser" class="btn btn-primary btn-block">Sign In</button>
									<!-- <button type="button"  class="btn btn-primary btn-block btn-lg hidden mt-lg">Sign In</button> -->
								</div>
								
							</div>	
							<div class="row">
								<div style="text-align:center">
									<a href="RegisterStudent">Student? Create new account?</a>
								</div>
