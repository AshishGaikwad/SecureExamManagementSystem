<%@page import="batu.dev.sem.bundles.UserManagement.daoimpl.UserDaoImpl"%>
...
<%
	...
	//long eid = 3;
	//long uid = 9;
	UserEntity lUserEntity = new UserDaoImpl().getUser(uid);
	...
	response.setHeader("Content-disposition","filename=RESULT_"+eid+"_"+uid+".doc");  
%>
<!DOCTYPE html>
<html>
<head>
